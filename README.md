...
└── src
    ├──components
    │   ├── books.js #component the renders one book of the bookshelf
    │   ├── bookshelf.js #component the renders one shelf
    │   ├── search.js #component the renders the search page of the app
